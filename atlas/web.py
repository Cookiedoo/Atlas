...
def test_detail(store: ExperimentStore, evaluation_id: str) -> dict[str, Any] | None:
    ...
    learned_summary = {"what_learned": analysis.get("what_learned", ""), "what_changed": analysis.get("what_changed", {}), "what_failed": analysis.get("what_failed"), "next_experiment": analysis.get("next_experiment", ""), "runtime": analysis.get("runtime", {})}
